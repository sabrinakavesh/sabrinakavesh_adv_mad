...
private let reuseIdentifier = "Cell" //constant 'cell' that we named in storyboard

class CollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout { //need to conform to to define size of cells
    
    var albumImages = [String]() //this is lazy way to do this, but hsould use mvc structure in practice
